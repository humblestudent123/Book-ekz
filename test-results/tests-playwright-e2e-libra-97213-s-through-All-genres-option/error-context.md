...
- Name: tests\playwright\e2e\library.spec.js >> Library page >> filters books by genre and resets through All genres option
- Location: tests\playwright\e2e\library.spec.js:20:3
