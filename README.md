...
Тестирование E2E тесты Cypress
Установка

#1 Установите зависимости
npm install # ставит Cypress и вспомогательные dev-зависимости

npm run cypress:install # npm run cypress:install нужна только если бинарник Cypress не скачался автоматически или кеш был очищен.
